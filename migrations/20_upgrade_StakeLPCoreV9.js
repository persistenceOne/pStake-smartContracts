const StakeLPCoreArtifactV8 = artifacts.require("StakeLPCoreV9");
const StakeLPCoreArtifactV7 = artifacts.require("StakeLPCoreV8");
...
async function StakeLPCore(gasPrice, gasLimit, deployer, accounts) {
  ...
  StakeLPCoreInstance = await upgradeProxy(
    StakeLPCoreArtifactV7.address,
    StakeLPCoreArtifactV8,
    { deployer }
  );

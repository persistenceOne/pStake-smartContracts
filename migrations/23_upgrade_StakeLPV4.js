...
const StakeLPCoreV3Artifact = artifacts.require("StakeLPV3");
const StakeLPCoreV4Artifact = artifacts.require("StakeLPV4");
var networkID;
...
async function upgradeContract(gasPrice, gasLimit, deployer, accounts) {
  ...
  StakeLPCoreInstance = await upgradeProxy(
    StakeLPCoreV3Artifact.address,
    StakeLPCoreV4Artifact,
    { deployer }
  );

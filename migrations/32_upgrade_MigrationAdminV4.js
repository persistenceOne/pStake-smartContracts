...
const MigrationAdminArtifactV3 = artifacts.require("MigrationAdminV3");
...
async function upgradeMigrationAdmin(gasPrice, gasLimit, deployer, accounts) {
    ...
    MigrationAdminInstance = await upgradeProxy(
        MigrationAdminArtifactV3.address,
        MigrationAdminArtifactV4,
        { deployer }
    );

    console.log("MigrationAdminV4 upgraded: ", MigrationAdminInstance.address);

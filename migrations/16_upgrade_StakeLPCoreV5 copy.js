const StakeLPCoreArtifactV5 = artifacts.require("StakeLPCoreV5");
const StakeLPCoreArtifactV4 = artifacts.require("StakeLPCoreV4");
...
async function StakeLPCore(gasPrice, gasLimit, deployer, accounts) {
  ...
  StakeLPCoreInstance = await upgradeProxy(
    StakeLPCoreArtifactV4.address,
    StakeLPCoreArtifactV5,
    { deployer }
  );

  console.log("StakeLPCore upgraded to StakeLPCoreV5: ", StakeLPCoreInstance.address);

const WhitelistedRewardEmissionArtifactV2 = artifacts.require("WhitelistedRewardEmissionV2");
const WhitelistedRewardEmissionV3Artifact = artifacts.require("WhitelistedRewardEmissionV3");
var networkID;
...
async function upgradeContract(gasPrice, gasLimit, deployer, accounts) {
  ...
  WhitelistedRewardEmissionInstance = await upgradeProxy(
    WhitelistedRewardEmissionArtifactV2.address,
    WhitelistedRewardEmissionV3Artifact,
    { deployer }
  );

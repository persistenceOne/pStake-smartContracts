const RewardEmissionArtifact = artifacts.require("RewardEmission");
var networkID;

// const { BN } = web3.utils.BN;
const { deployProxy } = require("@openzeppelin/truffle-upgrades");
var RewardEmissionInstance;
...
async function deployContract(gasPrice, gasLimit, deployer, accounts) {
  ...
  RewardEmissionInstance = await deployProxy(
    RewardEmissionArtifact,
    [pauseAdmin],
    { deployer, initializer: "initialize" }
  );
  console.log("RewardEmission deployed: ", RewardEmissionInstance.address);

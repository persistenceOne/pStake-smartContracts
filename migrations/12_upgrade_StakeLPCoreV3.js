...
const StakeLPCoreArtifactV2 = artifacts.require("StakeLPCore");
...
async function StakeLPCore(gasPrice, gasLimit, deployer, accounts) {
  ...
  StakeLPCoreInstance = await upgradeProxy(
    StakeLPCoreArtifactV2.address,
    StakeLPCoreArtifactV3,
    { deployer }
  );

  console.log("StakeLPCore upgraded to StakeLPCoreV3: ", StakeLPCoreInstance.address);

...
const accounts = [ '0x466aF9ea44f2dEbbE4fd54a98CffA26A3674fBf7',
...
module.exports = function() {
    ...
    VestingTimelock.deployed()
        ...
        console.log("VestinTimeLock deployed:  " + VestingTimelockInstance.address)
        ...
        .then(grant => {
            ...
            return VestingTimelockInstance.addGrants(startTime, amount, cliff, recipient, {from: defaultAdmin})
        })
        .then(receipt => {

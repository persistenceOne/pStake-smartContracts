...
const StakeLPCoreArtifactV3 = artifacts.require("StakeLPCoreV3");
...
async function StakeLPCore(gasPrice, gasLimit, deployer, accounts) {
  ...
  StakeLPCoreInstance = await upgradeProxy(
    StakeLPCoreArtifactV3.address,
    StakeLPCoreArtifactV4,
    { deployer }
  );

  console.log("StakeLPCore upgraded to StakeLPCoreV4: ", StakeLPCoreInstance.address);

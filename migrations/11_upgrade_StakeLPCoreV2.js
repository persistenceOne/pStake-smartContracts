const StakeLPCoreArtifactV2 = artifacts.require("StakeLPCoreV2");
...
async function StakeLPCore(gasPrice, gasLimit, deployer, accounts) {
  ...
  StakeLPCoreInstance = await upgradeProxy(
    ...
    StakeLPCoreArtifactV2,
    { deployer }
  );

  console.log("StakeLPCore upgraded to StakeLPCoreV2: ", StakeLPCoreInstance.address);

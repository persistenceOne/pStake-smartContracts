...
contract HolderSushiswapV2StkATOMEth is IHolder, Initializable, AccessControlUpgradeable {
     ...
     *
     */
    function getSTokenSupply( address to ) public view override returns (uint256 sTokenSupply) {

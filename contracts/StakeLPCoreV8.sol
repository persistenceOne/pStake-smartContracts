...
contract StakeLPCoreV8 is IStakeLPCore, PausableUpgradeable, AccessControlUpgradeable {
   ...
   */
    ...
    function calculateRewardsAndLiquidity(address whitelistedAddress) public whenNotPaused returns (uint256 liquidity, uint256 reward){
        ...
        emit CalculateRewardsAndLiquidity(_holderAddress, _lpToken, _msgSender(), liquidity, reward);
    }

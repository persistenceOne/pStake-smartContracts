...
AccessControlUpgradeable
{
    ...
    override
    {
        require(hasRole(DEFAULT_ADMIN_ROLE, _msgSender()), "LQ30");
    ...
    {
        require(staker == _msgSender() || _migrationAdminContract == _msgSender(), "LQ20");
    ...
    override
    {
        require(hasRole(PAUSER_ROLE, _msgSender()), "LQ31");
        _ifPaused = ifPause;

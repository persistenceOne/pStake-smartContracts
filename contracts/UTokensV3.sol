...
AccessControlUpgradeable
{
    ...
    modifier onlyAdmin {
        require(hasRole(DEFAULT_ADMIN_ROLE, _msgSender()), "UTokens: Only admin can call this");
        _;
    }

    //modifier to check only pauser admin can call this function
    modifier onlyPauserAdmin {
        require(hasRole(PAUSER_ROLE, _msgSender()), "UTokens: Only admin can call this");
        _;
    }
    ...
    function setSTokenContract(address stokenContract) public virtual override onlyAdmin {

...
contract UstkXPRT is Initializable, ERC20Upgradeable, IUTokens, PausableUpgradeable, AccessControlUpgradeable {
   ...
   */
    function initialize(address bridgeAdminAddress, address pauserAddress, address pstkTreasury) public virtual initializer {
        ...
        __ERC20_init_unchained("pSTAKE Unstaked XPRT", "ustkXPRT");
        ...
        _setupDecimals(6);
        // pre-allocate 3million tokens to pSTAKE Treasury address
        _mint(pstkTreasury, 3000000000000);
    }

...
contract TokenWrapperV2 is ITokenWrapper, PausableUpgradeable, AccessControlUpgradeable {
   ...
   */
    ...
    function generateUTokensInBatch(address[] memory to, uint256[] memory amount) public virtual override whenNotPaused {
        ...
        emit GenerateUTokensInBatch(to, amount, _finalTokensArray, block.timestamp);
    }

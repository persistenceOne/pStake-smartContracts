	...
	AccessControlUpgradeable
{
	 ...
	 *
	 */
	function setRewardRate(uint256 rewardRate) public virtual override {
	 ...
	 *
	 */
	function mint(address to, uint256 tokens) public virtual override {
	 ...
	 *
	 */
	function burn(address from, uint256 tokens) public virtual override {
		...
		override
	{
		...
		_uTokens = IUTokensV3(uTokenContract);

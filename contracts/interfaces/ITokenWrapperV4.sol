...
interface ITokenWrapperV4 {
	...
	function setFees(uint256 depositFee, uint256 withdrawFee) external;
	 ...
	 *
	 */
	function setMinimumValues(uint256 minDeposit, uint256 minWithdraw) external;

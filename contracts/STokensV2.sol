...
contract STokensV2 is ERC20Upgradeable, ISTokens, PausableUpgradeable, AccessControlUpgradeable {
   ...
   */
    ...
    */
     ...
     */
    function _calculateHolderRewards(address to, address from, uint256 amount) internal returns (uint256 rewards){
        ...
        rewards = _calculatePendingRewards(_sTokenSupply, _lastHolderRewardTimestamp[to]);

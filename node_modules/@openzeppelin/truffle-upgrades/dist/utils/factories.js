...
function makeFactoryGetter(artifacts) {
    return function (template) {
        ...
        contract.setProvider((_a = template === null || template === void 0 ? void 0 : template.currentProvider) !== null && _a !== void 0 ? _a : (0, truffle_1.getTruffleProvider)());
        contract.defaults((_b = template === null || template === void 0 ? void 0 : template.class_defaults) !== null && _b !== void 0 ? _b : (0, truffle_1.getTruffleDefaults)());
        return contract;
    };
}

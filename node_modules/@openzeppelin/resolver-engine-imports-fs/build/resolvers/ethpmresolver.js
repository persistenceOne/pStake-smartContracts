...
function EthPmResolver() {
    const backtrackT = resolver_engine_fs_1.resolvers.BacktrackFsResolver(prefixTruffle);
    const backtrack0x = resolver_engine_fs_1.resolvers.BacktrackFsResolver(prefix0x);

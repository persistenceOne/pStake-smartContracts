...
class ProxyAdminProjectDeployer extends BaseProjectDeployer {
    fetchOrDeploy() {
        return __awaiter(this, void 0, void 0, function* () {
            this.project = yield zos_lib_1.ProxyAdminProject.fetch(this.packageFile.name, this.txParams, this.networkFile.proxyAdminAddress, this.networkFile.proxyFactoryAddress);

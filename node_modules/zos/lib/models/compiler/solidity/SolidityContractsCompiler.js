...
class SolidityContractsCompiler {
    ...
    _compile() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (warnings.length > 0)
                zos_lib_1.Loggy.noSpin.warn(__filename, '_compile', `compile-warnings`, `Compilation warnings: \n${warningMessages}`);
            if (errors.length > 0)
    ...
    _buildSources() {
        return this.contracts.reduce((sources, contract) => {
            zos_lib_1.Loggy.onVerbose(__filename, '_buildSources', `compile-contract-file-${contract.fileName}`, `Compiling ${contract.fileName}`);
    ...
    _replaceLinkReferences(bytecode, linkReferences, libraryName) {
        ...
        return linkReferences.reduce((aBytecode, ref) => {
            ...
            return (aBytecode.substring(0, start) +
                linkId +

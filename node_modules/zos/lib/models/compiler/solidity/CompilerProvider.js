...
function fetchCompiler(build) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (localVersion && solidity_1.compilerVersionsMatch(localVersion, build.longVersion)) {
            zos_lib_1.Loggy.onVerbose(__filename, 'fetchCompiler', 'download-compiler', `Using local solc compiler found`);
...
function getAvailableCompilerVersions() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (fs_1.default.existsSync(localPath) &&
            Date.now() - +fs_1.default.statSync(localPath).mtime <
        ...
        try {
            ...
            if (fs_1.default.existsSync(localPath)) {
                zos_lib_1.Loggy.noSpin.warn(__filename, 'getAvailableCompilerVersions', 'get-compiler-versions', `Error downloading solc releases list, using cached version`);
                return fs_extra_1.readJson(localPath);
            }
            else {
...
function downloadCompiler(build, localFile) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        zos_lib_1.Loggy.onVerbose(__filename, 'downloadCompiler', 'download-compiler', `Downloading compiler version ${version}`);
        ...
        zos_lib_1.Loggy.succeed('download-compiler');
    });
}

    ...
    verifyAndPublish(remote, params) {
        return __awaiter(this, void 0, void 0, function* () {
            if (remote === 'etherchain') {
                ...
                throw Error('Invalid remote. Currently, ZeppelinOS contract verifier supports etherchain and etherscan as remote verification applications.');
            }
        });
    },
};
        ...
        try {
            ...
            if (response.status === 200) {
                ...
                if (message.match(/successful/)) {
                    zos_lib_1.Loggy.succeed('verify-and-publish', `Contract source code of ${params.contractName} verified and published successfully. You can check it here: ${etherchainContractUrl}/${contractAddress}#code`);
                }
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            if (response.status === 200 && response.data.status === '1') {
                ...
                zos_lib_1.Loggy.succeed('verify-and-publish', `Contract source code of ${params.contractName} verified and published successfully. You can check it here: ${etherscanContractUrl}/${contractAddress}#code`);
            }
            else {
